...
export class ThreadsComponent {
  ...
  expand() {
    this.thread.expand = !this.thread.expand;
  }

  expand_comments() {
    this.thread.view = !this.thread.view;
  }
